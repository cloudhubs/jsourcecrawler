...
public class SlicerEndpoint {
    ...
    //TODO: test endpoint request
    @PostMapping("/test")
    public List<Slice> test(@RequestBody SliceRequest s) {

        //TODO: Extract request identification info
        // (log the info for now, and run log clustering to determine request id value)
        ServletRequestAttributes attr = (ServletRequestAttributes) RequestContextHolder.currentRequestAttributes();
        HttpServletRequest request = attr.getRequest();

        //Get request id and session info
        String requestSessionID = request.getRequestedSessionId();
        HttpSession requestSession = request.getSession();

        RequestLogger.logger.info(requestSessionID + " " + requestSession.toString() + " entering");
...
//        return resp.getResponse();
        ...
        RequestLogger.logger.info(requestSessionID + " " + requestSession.toString() + " exiting");
